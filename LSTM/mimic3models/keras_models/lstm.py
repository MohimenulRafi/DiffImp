...
from keras.layers import Bidirectional, TimeDistributed # updated this replacing previous line for test - Mohimenul
...
class Network(Model):
    ...
    #input_dim=76 for default, 80 for gender, 82 for race, 78 for age, 82 for gender age, 84 for race age, 86 for gender race, 88 for gender race age
