...
# Build the model
model = build_model(input_dim = 82 ) # race
#model = build_model(input_dim = 80 ) # gender
# model = build_model(input_dim = 86 ) # race & gender
# Model summary
model.summary()
...
# Data/subgroup/ihm_age/Preprocessed_data
## Race
X_train = np.load("Data/subgroup/eicu/ihm_race/Preprocessed_data/train_X.npy")  # Random input data
y_train = np.load("Data/subgroup/eicu/ihm_race/Preprocessed_data/train_Y.npy")  # Binary target

X_val = np.load("Data/subgroup/eicu/ihm_race/Preprocessed_data/val_X.npy")  # Random validation data
y_val = np.load("Data/subgroup/eicu/ihm_race/Preprocessed_data/val_Y.npy")  # Binary validation target


## Gender
# X_train = np.load("Data/subgroup/eicu/ihm_gender/Preprocessed_data/train_X.npy")  # Random input data
# y_train = np.load("Data/subgroup/eicu/ihm_gender/Preprocessed_data/train_Y.npy")  # Binary target

# X_val = np.load("Data/subgroup/eicu/ihm_gender/Preprocessed_data/val_X.npy")  # Random validation data
# y_val = np.load("Data/subgroup/eicu/ihm_gender/Preprocessed_data/val_Y.npy")  # Binary validation target

## rance and gender
# X_train = np.load("Data/subgroup/eicu/ihm_gender_race/Preprocessed_data/train_X.npy")  # Random input data
# y_train = np.load("Data/subgroup/eicu/ihm_gender_race/Preprocessed_data/train_Y.npy")  # Binary target

# X_val = np.load("Data/subgroup/eicu/ihm_gender_race/Preprocessed_data/val_X.npy")  # Random validation data
# y_val = np.load("Data/subgroup/eicu/ihm_gender_race/Preprocessed_data/val_Y.npy")  # Binary validation target

################# Set path #################

# Save the model after each epoch
# save_path = "Models/Transformer_subgroup/ihm_race/Trial_3"
save_path = "Models/Transformer_subgroup/eicu_ihm_race/Trial_3"
